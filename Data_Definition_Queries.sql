...
CREATE TABLE flights (
	...
	FOREIGN KEY (destination) REFERENCES destinations(city) ON DELETE CASCADE,
...
INSERT INTO flights (airline_designator, flight_number, departure_time, arrival_time, destination, plane) 
	VALUES ('UA', 345, '2019-02-10 22:33:15', '2019-02-11 08:15:09', 'London', 1), 
	('AA', 2055, '2019-02-11 00:24:16', '2019-02-11 06:20:54', 'Chicago', 2), 
	('AA', 155, '2019-02-11 02:13:17', '2019-02-11 07:50:43', 'Seattle', 3); 
